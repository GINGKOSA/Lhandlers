...
window.PAGES["farkeyes"] = `<div class="page-header">
        ...
        <div class="page-tags">
          ...
          <span class="tag red">Reptiliens peau rouge</span>
          <span class="tag red">Compatibles Demonite — exception biologique</span>
          <span class="tag red">Seule espèce conquérante</span>
          <span class="tag gold">Anciens bétails énergétiques</span>
        </div>
      </div>
      <div class="infobox">
...
chaleur extrême également — ce qui explique pourquoi le biome volcanique
 de Farkaras ne les affecte pas.</p>
        <p class="mt-10">Cette période d'exploitation est <strong>gravée dans leur biologie</strong>
 autant que dans leur culture. La compatibilité totale avec la Demonite 
n'est pas un don — c'est la trace permanente de ce qu'on leur a fait.</p>
      </div>

      <div class="wiki-section">
        <div class="wiki-section-title">🌋 Farkaras — Le Territoire Forgé</div>
        <p>À l'origine, Scioprius était une planète <strong>rayonnante et verdoyante</strong> — le monde natal des Firigilians. Les guerres successives pour la pourpalite ont tout brûlé, tout transformé. Ce qui en reste est aujourd'hui un monde de <strong>lave, de volcans et de chaleur extrême</strong> — Drakarnias, la capitale.</p>
        <p class="mt-10">Une fois libérés, les Farkeyes ont nommé leur empire <strong>Farkaras</strong> — englobant tous les territoires conquis dans le disque. Et surtout : ils sont <strong>restés</strong> sur les ruines de Scioprius.</p>
      </div>

      <div class="wiki-section">
        <div class="wiki-section-title">⚔ Idéologie — La Force Comme Seule Loi</div>
        <p>Pour aider à saisir l'esprit de la civilisation Farkeyes, le modèle le plus proche que les spectateurs connaissent est celui des <strong>Spartiates</strong> — une culture bâtie en réponse directe à des siècles de réduction à l'état de ressource. Une espèce qui a été du bétail construit une culture où <strong>la faiblesse est le pire des crimes</strong>.</p>
        <div class="card red">
          <div class="card-title">Valeurs Fondamentales</div>
          <p>La force brute comme valeur suprême. La conquête pour la gloire, pas pour les ressources. Le mépris de tout ce qui n'est pas la force.</p>
          <p class="mt-8">Mourir au combat reste une mort — et mourir, c'est avoir perdu. Ce n'est pas glorieux en soi. Mais c'est infiniment <strong>mieux perçu que mourir de vieillesse</strong>, qui signifie n'avoir jamais trouvé d'adversaire à ta hauteur, ou pire — avoir évité le combat. La mort au combat est une défaite acceptable. La vieillesse est une honte.</p>
        </div>
        <div class="card red">
        ...
        <div class="card red">
          <div class="card-title">Les Escouades Volontaires — La Seule Forme de Collectif</div>
          <p>La seule manière dont les Farkeyes s'organisent ensemble : un porteur de rang élevé sort dans les rues, annonce qu'il part attaquer un endroit, et ceux qui veulent se couvrir de gloire le suivent. <strong>Aucune obligation. Aucune conscription.</strong> On vient parce qu'on veut du combat, pas parce qu'on y est contraint.</p>
          <p class="mt-8">Ces escouades se forment et se dissolvent librement. Un Farkeyes peut en rejoindre plusieurs, n'en rejoindre aucune, ou en créer une lui-même s'il a assez de cicatrices pour que d'autres le suivent.</p>
        </div>
        <div class="card red">
...
universelle au sein de l'espèce : <strong>seuls les Farkeyes portant au moins une cicatrice</strong> peuvent activer des pouvoirs. Un Farkeyes sans cicatrice qui touche de la Demonite n'obtiendra rien. <strong>Le rang biologique est la condition d'accès au pouvoir.</strong></p>
        <p class="mt-8">Pour ceux qui sont compatibles, une fois le premier contact établi, le lien est permanent et <strong>indépendant de la distance</strong>. L'objet peut être éloigné — les pouvoirs restent actifs. Impossible à neutraliser par le vol.</p>
        <p class="p-note">Conséquence directe : la masse des soldats et civils sans cicatrice — la majorité de l'espèce — n'aura jamais accès aux pouvoirs, quelles que soient les quantités de Demonite disponibles. Le pouvoir et le rang ne font qu'un.</p>
      </div>

      <div class="wiki-section">
        <div class="wiki-section-title">⊕ Hiérarchie — Les Cicatrices Jaunes</div>
        <p>Le rang est <strong>inscrit biologiquement</strong> sur l'œil gauche sous forme de cicatrices jaunes. Impossible à falsifier — le corps ne ment pas. Les cicatrices <strong>ne comptent pas les victoires</strong> : elles indiquent le <strong>rang exact</strong> de la personne vaincue. Battre un Général, c'est devenir Général — immédiatement, biologiquement, sans transition.</p>
        <div class="hierarchy">
          <div class="rank"><div class="rank-eyes">⊕⊕⊕⊕</div><div class="rank-label">Chef Suprême</div><div class="rank-note">UN SEUL possible</div></div>
          <div class="rank"><div class="rank-eyes">⊕⊕⊕</div><div class="rank-label">Général</div><div class="rank-note">Nombre restreint</div></div>
          <div class="rank"><div class="rank-eyes">⊕⊕</div><div class="rank-label">Commandant</div><div class="rank-note">Plus nombreux</div></div>
          <div class="rank"><div class="rank-eyes">⊕</div><div class="rank-label">Officier</div><div class="rank-note">Encore plus nombreux</div></div>
          <div class="rank"><div class="rank-eyes">○</div><div class="rank-label">Soldat / Civil</div><div class="rank-note">Masse</div></div>
        </div>
        ...
        <div class="card red mt-10">
          <div class="card-title">Cicatrices de Naissance — Le Facteur Aléatoire</div>
          <p>Certains Farkeyes <strong>naissent avec des cicatrices</strong>. Aléatoire, imprévisible, biologiquement inexpliqué. Ce phénomène régule naturellement les morts hors-combat : de nouveaux porteurs de rang émergent sans qu'un combat soit nécessaire.</p>
          <p class="mt-8">Naître avec des cicatrices est à double tranchant : plus de rang, mais aussi <strong>vulnérabilité immédiate</strong>. Même un nouveau-né porteur d'un rang élevé peut être tué par n'importe quel Farkeyes qui convoite ses cicatrices. La société Farkeyes ne connaît pas l'innocence de l'enfance pour ceux qui naissent au rang.</p>
          <div class="mini-grid">
            <div class="mini-grid-card red">
              <div class="mini-grid-card-label">VISION POSITIVE</div>
              <p>Marqués par le destin. Porteurs d'une puissance innée. Le biologique ne ment pas — naître avec ce rang, c'est être fait pour lui.</p>
            </div>
            <div class="mini-grid-card red">
              <div class="mini-grid-card-label">VISION PURISTE</div>
              <p>Un rang non gagné au combat est une honte. Un Général de naissance n'a rien prouvé — et tout le monde le sait.</p>
            </div>
          </div>

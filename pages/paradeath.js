window.PAGES["paradeath"] = `<div class="page-header">      <div class="page-title">Les Paradeath</div>
      ...
      <div class="page-tags">
        ...
        <span class="tag red">Contrôle total</span>
        <span class="tag gold">Volioce — nature</span>
        <span class="tag gold">Expérience Firigilians ratée</span>
      </div>
    </div>
    ...
    <div class="infobox">
      ...
      <div class="infobox-row"><div class="infobox-key">STATUT</div><div class="infobox-val">Libres — incontrôlables</div></div>
    </div>
    ...
    <div class="wiki-section">
      <div class="wiki-section-title">🧠 Physiologie — Le Cerveau Libre</div>
      <p>Un Paradeath libre ressemble à un cerveau organique légèrement plus grand qu'un poing humain, hérissé de tentacules courtes et préhensiles. Ils se déplacent lentement au sol ou en rampant le long des surfaces — vulnérables, exposés, sans défense apparente.</p>
      <p class="mt-10">Mais leur véritable état naturel, c'est <strong>sur un hôte</strong>. Fixé sur la nuque d'une créature, un Paradeath connecte ses tentacules directement au système nerveux et prend le <strong>contrôle total</strong> de son hôte — mouvements, parole, comportement. La proie est consciente mais impuissante, ou peut-être pas même ça. Personne ne sait avec certitude ce que vit l'hôte de l'intérieur.</p>
    </div>

    <div class="wiki-section">
      <div class="wiki-section-title">🔬 Origine — L'Échec Firigilians</div>
      <p>Les Firigilians avaient un problème pratique sur Volioce : les grandes espèces animales de la réserve naturelle étaient difficiles à étudier. Trop dangereuses, trop imprévisibles. L'idée était de créer un <strong>parasite de contrôle</strong> — un organisme capable de se fixer sur n'importe quelle grande espèce, de la rendre docile et coopérative, capable de répondre à des questions pour en extraire de la connaissance.</p>
      <p class="mt-10">L'expérience a fonctionné — partiellement. Les Paradeath contrôlaient bien leurs hôtes. Mais ils ne répondaient à aucune instruction Firigilians. Ils n'avaient aucun intérêt pour la coopération. Leur seule logique était la leur. <strong>L'outil était devenu incontrôlable.</strong></p>
      <p class="mt-10">Les Firigilians les ont enfermés. Ce qui semblait être la fin de l'histoire ne l'était pas.</p>
    </div>
    ...
    <div class="wiki-section">
      ...
      <div class="card red mt-14">
        ...
        <p>Les Firigilians ont voulu les contrôler — échec. Les Farkeyes ont voulu les weaponiser — échec. Les Paradeath n'ont jamais appartenu à personne. Deux des civilisations les plus puissantes de l'univers ont essayé de faire d'eux un outil, et les deux ont échoué. Ce n'est pas de la résistance consciente de leur part — c'est simplement que leur nature ne se plie à aucune intention extérieure.</p>
      </div>
    </div>

...
window.PAGES["demonite"] = `<div class="page-header">
        ...
        <div class="page-tags">
          ...
          <span class="tag purple">Lien à vie</span>
          <span class="tag purple">Pouvoirs selon le caractère</span>
          <span class="tag red">Née dans le massacre</span>
          <span class="tag gold">Issue de la pourpalite + sang Farkeyes</span>
        </div>
      </div>
      ...
      <div class="infobox">
        ...
        <div class="infobox-row"><div class="infobox-key">NOM</div><div class="infobox-val">Du massacre qui l'a créée</div></div>
      </div>
...
générateurs biologiques.</p>
      ...
      <div class="wiki-section">
        <div class="wiki-section-title">🩸 Origine — Le Massacre</div>
        <p>Lors des guerres sur <strong>Scioprius</strong> pour 
s'accaparer les cristaux de pourpalite (découverte sur la planète <strong>Platos</strong> puis répandue), les petits lézards locaux — 
ancêtres des Farkeyes — furent exposés à l'énergie du cristal et <strong>mutèrent</strong>.
...
universelle : <strong>seuls les Farkeyes portant au moins une cicatrice peuvent activer des pouvoirs</strong>.
 Un Farkeyes sans cicatrice n'obtiendra rien au contact de la Demonite. 
Pour ceux qui sont éligibles, une fois le premier contact établi, le 
...
La seule façon de neutraliser un Farkeyes c'est de le tuer.</p>
      ...
      <div class="wiki-section">
        <div class="wiki-section-title">💡 Pouvoirs — Reflet du Caractère</div>
        <p>Au contact d'un être compatible, la Demonite se <strong>lie à lui pour la vie</strong>
 et lui confère des pouvoirs uniques — façonnés par son caractère, sa 
psychologie, sa nature profonde. Un même fragment ne fonctionne que pour
 une seule personne. Un Élu peut passer toute sa vie sans jamais croiser
 de Demonite — et ne jamais savoir ce qu'il était.</p>
      </div>

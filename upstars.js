...
window.PAGES["upstars"] = `<div class="page-header">        <div class="page-title">Le Projet Upstars</div>
        ...
        <div class="page-tags">
          ...
          <span class="tag blue">Soldats d'&eacute;lite</span>
          <span class="tag red">Instrument de la trahison finale</span>
          <span class="tag gold">Aucun &eacute;chec connu</span>
        </div>
      </div>

      <div class="infobox">
        <div class="infobox-title">Upstars</div>
        <div class="infobox-row"><div class="infobox-key">TYPE</div><div class="infobox-val">Programme militaire d'&eacute;lite</div></div>
        <div class="infobox-row"><div class="infobox-key">COMMANDITAIRE</div><div class="infobox-val">Nations Unies</div></div>
        <div class="infobox-row"><div class="infobox-key">COMPOSITION</div><div class="infobox-val">Plusieurs petits groupes ind&eacute;pendants</div></div>
        <div class="infobox-row"><div class="infobox-key">ÉRE</div><div class="infobox-val">Terre &mdash; apr&egrave;s 2018</div></div>
        <div class="infobox-row"><div class="infobox-key">STATUT</div><div class="infobox-val">D&eacute;truit avec la Terre</div></div>
      </div>

      <div class="wiki-section">
        <p>Face &agrave; l'irruption soudaine de <strong>l'organisation terroriste</strong> qui s'est empar&eacute;e de la moiti&eacute; du globe en 2018, les Nations Unies lancent le projet <strong>Upstars</strong> : plusieurs petits groupes de soldats d'&eacute;lite form&eacute;s pour des <strong>missions impossibles</strong>.</p>
        <p class="mt-10">Un groupe se distingue de tous les autres : <strong>aucun &eacute;chec, aucune mission rat&eacute;e</strong>. Ils deviennent l'outil le plus pr&eacute;cieux &mdash; et le plus utilis&eacute; &mdash; des Nations Unies.</p>
      </div>
